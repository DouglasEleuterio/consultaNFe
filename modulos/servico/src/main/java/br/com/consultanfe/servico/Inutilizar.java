...
import br.com.consultanfe.util.*;
...
import br.com.gruposaga.cad.consultanfe.util.*;
...
/**
 * Classe Responsavel por inutilizar uma Faixa de numeracao da ServicosNFe.
 *
...
class Inutilizar {
    ...
    static TRetInutNFe inutiliza(InputStream nfeCacerts, String id, String motivo, String tipo, boolean validar) throws NfeException {
